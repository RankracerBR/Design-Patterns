...
class UserDirector:
    ...
    def with_adress(self, firstname, lastname, address):
        self._builder.add_firstname(firstname)\
                    .add_lastname(lastname)\
                    .add_address(address)
        return self._builder.result
...
if __name__ == "__main__":
    ...
    user1 = user_director.with_age('Augusto', 'Pontes', 21)
    user2 = user_director.with_age('Augusto', 'Pontes', 'Avenida Brasil')
    print(user1)
    print(user2)